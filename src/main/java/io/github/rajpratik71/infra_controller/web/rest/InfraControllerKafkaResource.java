...
@RestController
@RequestMapping("/api/infra-controller-kafka")
public class InfraControllerKafkaResource {

    private final Logger log = LoggerFactory.getLogger(InfraControllerKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public InfraControllerKafkaResource(KafkaProperties kafkaProperties) {
